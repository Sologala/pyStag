// borrowed in spirit from
// https://github.com/yati-sagade/opencv-ndarray-conversion MIT License
 ...
 * file inside modules/python/src2 folder (OpenCV 3.1.0)
 */
...
bool NDArrayConverter::toMat(PyObject *o, Mat &m) {
  ...
  for (int i = ndims - 1; i >= 0 && !needcopy; i--) {
    ...
    // the _sizes[i] > 1 is needed to avoid spurious copies when
    // NPY_RELAXED_STRIDES is set
